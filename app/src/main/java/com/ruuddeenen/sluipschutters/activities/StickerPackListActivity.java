...
package com.ruuddeenen.sluipschutters.activities;
...
import com.ruuddeenen.sluipschutters.R;
import com.ruuddeenen.sluipschutters.models.StickerPack;
import com.ruuddeenen.sluipschutters.adapters.StickerPackListAdapter;
import com.ruuddeenen.sluipschutters.util.StickerPackListItemViewHolder;
import com.ruuddeenen.sluipschutters.util.WhitelistCheck;
...
public class StickerPackListActivity extends AddStickerPackActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        FrameLayout button = findViewById(R.id.btn_website);
        button.setOnClickListener(v -> {
            Intent browserIntent = new Intent(Intent.ACTION_VIEW, Uri.parse("http://sluipschutters.ruuddeenen.com"));

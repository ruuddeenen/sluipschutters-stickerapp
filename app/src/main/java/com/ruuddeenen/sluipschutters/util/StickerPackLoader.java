...
package com.ruuddeenen.sluipschutters.util;
...
import com.ruuddeenen.sluipschutters.BuildConfig;
import com.ruuddeenen.sluipschutters.models.Sticker;
import com.ruuddeenen.sluipschutters.models.StickerPack;
...
import static com.ruuddeenen.sluipschutters.util.StickerContentProvider.ANDROID_APP_DOWNLOAD_LINK_IN_QUERY;
import static com.ruuddeenen.sluipschutters.util.StickerContentProvider.AVOID_CACHE;
import static com.ruuddeenen.sluipschutters.util.StickerContentProvider.IOS_APP_DOWNLOAD_LINK_IN_QUERY;
import static com.ruuddeenen.sluipschutters.util.StickerContentProvider.LICENSE_AGREENMENT_WEBSITE;
import static com.ruuddeenen.sluipschutters.util.StickerContentProvider.PRIVACY_POLICY_WEBSITE;
import static com.ruuddeenen.sluipschutters.util.StickerContentProvider.PUBLISHER_EMAIL;
import static com.ruuddeenen.sluipschutters.util.StickerContentProvider.PUBLISHER_WEBSITE;
import static com.ruuddeenen.sluipschutters.util.StickerContentProvider.STICKER_FILE_EMOJI_IN_QUERY;
import static com.ruuddeenen.sluipschutters.util.StickerContentProvider.STICKER_FILE_NAME_IN_QUERY;
import static com.ruuddeenen.sluipschutters.util.StickerContentProvider.STICKER_PACK_ICON_IN_QUERY;
import static com.ruuddeenen.sluipschutters.util.StickerContentProvider.STICKER_PACK_IDENTIFIER_IN_QUERY;
import static com.ruuddeenen.sluipschutters.util.StickerContentProvider.STICKER_PACK_NAME_IN_QUERY;
import static com.ruuddeenen.sluipschutters.util.StickerContentProvider.STICKER_PACK_PUBLISHER_IN_QUERY;
import static com.ruuddeenen.sluipschutters.util.StickerContentProvider.IMAGE_DATA_VERSION;
